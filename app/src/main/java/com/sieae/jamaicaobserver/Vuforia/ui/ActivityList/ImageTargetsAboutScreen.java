...
/**
 * Created by Mohammad Arshi Khan on 06-02-2017.
 */

public class ImageTargetsAboutScreen extends Activity implements View.OnClickListener
{
...
//        setPermission();
        ...
        ImageTargetsAboutScreen.AboutWebViewClient aboutWebClient = new ImageTargetsAboutScreen.AboutWebViewClient();
...
//                                ActivityCompat.requestPermissions(ImageTargetsAboutScreen.this, permissionsList.toArray(new String[permissionsList.size()]),
...
//        new AlertDialog.Builder(ImageTargetsAboutScreen.this)
//                .setMessage(message)
...
//                } else {
//                    // Permission Denied
//                    Toast.makeText(ImageTargetsAboutScreen.this, "Some Permission is Denied", Toast.LENGTH_SHORT)
//                            .show();
//                }
//            }
//            break;
